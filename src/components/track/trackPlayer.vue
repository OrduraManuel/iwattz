...
<template>
    <div class="wrapper" id="appz">
      <div class="player">
        <div class="player__top">
          <div class="player-cover">
            <transition-group :name="transitionName">
                <div class="player-cover__item" :style="{ backgroundImage: `url(${props.song.Img?.Path})` }" ></div>
            </transition-group>
          </div>
        ...
        <div class="progress" ref="progress" style="display:flex;flex-direction: column; justify-content: space-around ; height: 100%; border-radius:0;">
